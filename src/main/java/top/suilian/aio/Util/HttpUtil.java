...
//        get.addHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
    ...
    public static  String postByPackcoin(String url, Map<String, String> params, Map<String, String> headers) throws UnsupportedEncodingException {
        List<NameValuePair> list = new LinkedList<>();
        for (String key : params.keySet()) {
            BasicNameValuePair param1 = new BasicNameValuePair(key, String.valueOf(params.get(key)));
            list.add(param1);
    ...
    public static  String postByPackcoin1(String url, Map<String, Object> params, Map<String, String> headers) throws UnsupportedEncodingException {
        List<NameValuePair> list = new LinkedList<>();
        for (String key : params.keySet()) {
            BasicNameValuePair param1 = new BasicNameValuePair(key, String.valueOf(params.get(key)));
            list.add(param1);
