package top.suilian.aio.service.hkex.newKline;
...
public class NewHkexKline extends HkexParentService {
    public NewHkexKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_HKEX_KLINE, id);
    }
    ...
    private void startOpenInterval(BigDecimal buyPri, BigDecimal buyAmount) {
        try {
            ...
            if (resultJson != null && jsonObject.getInt("code") == 0) {
                ...
                if (str != null && result.getInt("code") == 0) {
