package top.suilian.aio.service.hkex.depth;
...
import top.suilian.aio.service.hkex.HkexParentService;
...
public class HkexRandomDepth extends HkexParentService {
    public HkexRandomDepth(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_HKEX_DEPTH, id);
    }
    ...
    public void init() {
        ...
        if (Integer.parseInt(exchange.get("depthCancelNum")) >= depthCancelOrderNum) {
            ...
            try {
                ...
                if("0".equals(sellResultObject.getString("code"))){
    ...
    public List<BigDecimal> getDepth() {
        ...
        String trades = httpUtil.get("https://openapi.hkex.me/open/api/market_dept?symbol=" + exchange.get("market") + "&type=step0");
