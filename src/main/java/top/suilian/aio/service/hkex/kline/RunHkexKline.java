...
public class RunHkexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        HkexKline kline = new HkexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
