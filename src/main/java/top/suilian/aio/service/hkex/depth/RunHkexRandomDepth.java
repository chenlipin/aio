...
@Component
public class RunHkexRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        HkexRandomDepth randomDepth = new HkexRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        HkexRandomDepth randomDepth;

        public Work(HkexRandomDepth randomDepth) {
