...
public class RunNewBikaKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewBikaKline kline = new NewBikaKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewBikaKline kline) {
            super(kline.id);
            this.kline = kline;
        }
