...
public class RunBikaReplenish {
    ...
    public void init(int id) {
        //实例化策略对象
        BikaReplenish randomDepth = new BikaReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        BikaReplenish randomDepth;

        public Work(BikaReplenish randomDepth) {
