...
public class RunZGKline {
    ...
    public void init(int id) {
        //实例化策略对象
        ZGKline kline = new ZGKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
