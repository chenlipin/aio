package top.suilian.aio.service.huobi.refToHot;
...
public class RunPoloniexRep2Hot {
    ...
    public void init(int id) {
        //实例化策略对象
        HuobiRep2Hot randomDepth = new HuobiRep2Hot(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        HuobiRep2Hot randomDepth;

        public Work(HuobiRep2Hot randomDepth) {
