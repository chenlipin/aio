package top.suilian.aio.service.huobi.newKline;
...
public class RunNewHuobiKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewHobiKline kline = new NewHobiKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewHobiKline kline) {
            super(kline.id);
            this.kline = kline;
        }
