...
public class RunBirtureKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewBitureKline kline = new NewBitureKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewBitureKline kline;

        public Work(NewBitureKline kline) {
            super(kline.id);
            this.kline = kline;
        }
