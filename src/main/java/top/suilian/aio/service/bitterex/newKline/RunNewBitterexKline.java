...
@Component
public class RunNewBitterexKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewBitterexKline kline = new NewBitterexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewBitterexKline kline;

        public Work(NewBitterexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
