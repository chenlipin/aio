...
public class RunCeohkKline {
    ...
    public void init(int id) {
        //实例化策略对象
        CeohkKline kline = new CeohkKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
