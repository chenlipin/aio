package top.suilian.aio.service.asproex.kline;
...
public class RunAsproexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        AsproexKline kline = new AsproexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(AsproexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
