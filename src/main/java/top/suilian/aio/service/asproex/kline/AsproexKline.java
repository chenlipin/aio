...
import top.suilian.aio.service.asproex.AsproexParentService;
...
public class AsproexKline extends AsproexParentService {
    ...
    public AsproexKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_ASPROEX_KLINE, id);
    }
