...
public class RunEgKline {
    ...
    public void init(int id) {
        //实例化策略对象
        EGKline kline = new EGKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
