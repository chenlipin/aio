...
public class RunEgDepth {
    ...
    public void init(int id) {
        //实例化策略对象
        EgDepth randomDepth = new EgDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(EgDepth randomDepth) {
