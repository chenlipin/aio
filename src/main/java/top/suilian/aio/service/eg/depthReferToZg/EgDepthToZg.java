package top.suilian.aio.service.eg.depthReferToZg;
...
public class EgDepthToZg extends EgParentService {
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        String s2 = submitOrder(1,new BigDecimal("66421"), new BigDecimal("1"));
        ...
        if(depth!=null&&depth.get("bids")!=null&&depth.get("asks")!=null) {
            ...
            for (int i = 0; i < sellNum; i++) {
                ...
                if(isCny){
                    finalSellPrice = nN(new BigDecimal(String.valueOf(neadSell.get(i).get(0))).multiply(new BigDecimal(exchangeRate)), Integer.parseInt(precision.get("pricePrecision").toString()));
            ...
            for (int i = 0; i < buyNum; i++) {
                ...
                if(isCny){
                    ...
                    finalBuyPrice = nN(new BigDecimal(String.valueOf(neadBuy.get(i).get(0))).multiply(new BigDecimal(exchangeRate)), Integer.parseInt(precision.get("pricePrecision").toString()));
