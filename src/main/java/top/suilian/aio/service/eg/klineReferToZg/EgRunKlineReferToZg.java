...
@Component
public class EgRunKlineReferToZg {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        EgKlineToZg kline = new EgKlineToZg(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
