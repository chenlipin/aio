...
import top.suilian.aio.service.eg.kline.EGKline;
...
public class RunNewEgKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewEgKline kline = new NewEgKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
