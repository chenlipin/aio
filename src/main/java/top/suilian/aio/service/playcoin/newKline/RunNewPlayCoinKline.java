...
import top.suilian.aio.service.playcoin.kline.PlayCoinKline;
...
@Component
public class RunNewPlayCoinKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewPlayCoinKline kline = new NewPlayCoinKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewPlayCoinKline kline;

        public Work(NewPlayCoinKline kline) {
            super(kline.id);
            this.kline = kline;
        }
