package top.suilian.aio.service.playcoin.kline;
...
public class PlayCoinKline extends PlayCoinParentService {
    public PlayCoinKline(
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        //String s = submitTrade(1, new BigDecimal("3.1305"), new BigDecimal("0.01"));
       // String s = cancelTrade("1245254625238450199", "1");
      //  setBalanceRedis();
        //String s = selectOrder("1245254625238450199");
        setTransactionRatio();
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            ...
            int type = Math.ceil(Math.random() * 10 ) > Integer.valueOf(exchange.get("tradeRatio")) ? 1 : 2;
