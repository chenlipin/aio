...
public class RunPlayCoinKline {
    ...
    public void init(int id) {
        //实例化策略对象
        PlayCoinKline kline = new PlayCoinKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(PlayCoinKline kline) {
            super(kline.id);
            this.kline = kline;
        }
