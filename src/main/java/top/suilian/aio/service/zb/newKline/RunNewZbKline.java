package top.suilian.aio.service.zb.newKline;
...
public class RunNewZbKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewZbKline kline = new NewZbKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
