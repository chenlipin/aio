...
public class RunHwancKline {
    ...
    public void init(int id) {
        //实例化策略对象
        HwancKline kline = new HwancKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
