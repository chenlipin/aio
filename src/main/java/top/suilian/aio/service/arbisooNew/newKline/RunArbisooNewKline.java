...
@Component
public class RunArbisooNewKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        ArbisooNewNewKline kline = new ArbisooNewNewKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ArbisooNewNewKline kline;

        public Work(ArbisooNewNewKline kline) {
            super(kline.id);
            this.kline = kline;
        }
