...
public class RunCitexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        CitexKline kline = new CitexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
