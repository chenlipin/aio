...
public class RunGokoKline {
    ...
    public void init(int id) {
        //实例化策略对象
        GokoKline kline = new GokoKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
