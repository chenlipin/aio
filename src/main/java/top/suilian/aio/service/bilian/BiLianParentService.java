...
public class BiLianParentService extends BaseService {
    public String baseUrl = "https://openapi.9ccex.com/exchange-open-api/open/api";
    ...
    public void setPrecision() {
            ...
            JSONObject rtObj = judgeRes(rt, "data", "setPrecision");
            ...
            if (!rt.equals("") && rtObj != null) {
                ...
                for (Map<String, Object> data : symbols) {
                    if (this.exchange.get("market").equals(data.get("symbol"))) {

                        precision.remove("pricePrecision");
                        precision.put("pricePrecision", data.get("price_precision"));
                        precision.remove("amountPrecision");
                        precision.put("amountPrecision", data.get("amount_precision"));
