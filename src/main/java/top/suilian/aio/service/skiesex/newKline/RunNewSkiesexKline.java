package top.suilian.aio.service.skiesex.newKline;
...
@Component
public class RunNewSkiesexKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewSkiesexKline kline = new NewSkiesexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewSkiesexKline kline;

        public Work(NewSkiesexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
