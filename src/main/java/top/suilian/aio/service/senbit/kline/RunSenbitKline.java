...
import top.suilian.aio.service.qb.kline.QbKline;
...
public class RunSenbitKline {
    ...
    public void init(int id) {
        //实例化策略对象
        SenbitKline kline = new SenbitKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
