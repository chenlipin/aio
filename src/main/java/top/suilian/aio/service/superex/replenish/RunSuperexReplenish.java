package top.suilian.aio.service.superex.replenish;
...
@Component
public class RunSuperexReplenish {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        SuperexReplenish randomDepth = new SuperexReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        SuperexReplenish randomDepth;

        public Work(SuperexReplenish randomDepth) {
