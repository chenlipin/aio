...
public class RunSuperexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewSuperexKline kline = new NewSuperexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewSuperexKline kline;

        public Work(NewSuperexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
