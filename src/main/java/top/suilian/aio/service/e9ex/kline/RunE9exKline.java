...
public class RunE9exKline {
    ...
    public void init(int id) {
        //实例化策略对象
        E9exKline kline = new E9exKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
