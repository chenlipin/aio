package top.suilian.aio.service.e9ex;
...
public class E9exParentService extends BaseService {
    public String baseUrl = "https://openapi.e9ex.com";
    ...
    public void setBalanceRedis() throws UnsupportedEncodingException {
        ...
        if (balance == null || overdue) {
            ...
            String baseUrl = "https://openapi.e9ex.com";
    ...
    public void setCancelOrder(JSONObject cancelRes, String res, String orderId, Integer type) {
        ...
        insertCancel(id, orderId, 1, type, Integer.parseInt(exchange.get("isMobileSwitch")), cancelStatus, res, Constant.KEY_EXCHANGE_E9EX);
    }
