package top.suilian.aio.service.e9ex.kline;
...
import top.suilian.aio.service.e9ex.E9exParentService;
...
public class E9exKline extends E9exParentService {
    public E9exKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_E9EX_KLINE, id);
    }
    ...
    public void init() {
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            ...
            //获取深度 判断平台撮合是否成功https://openapi.e9ex.com/
            String trades = httpUtil.get("https://openapi.e9ex.com/open/api/market_dept?symbol=" + exchange.get("market") + "&type=step0");
