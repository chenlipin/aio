...
public class RunBiboxKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BiboxKline kline = new BiboxKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
