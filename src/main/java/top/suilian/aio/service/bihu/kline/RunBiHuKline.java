...
public class RunBiHuKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BiHuKline kline = new BiHuKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
