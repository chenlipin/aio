...
public class RunBihuNewKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BihuNewKline kline = new BihuNewKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(BihuNewKline kline) {
            super(kline.id);
            this.kline = kline;
        }
