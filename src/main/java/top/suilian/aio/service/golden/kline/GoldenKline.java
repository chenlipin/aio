package top.suilian.aio.service.golden.kline;
...
public class GoldenKline extends GoldenParentService {
    ...
    public GoldenKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_GOLDEN_KLINE, id);
    }
