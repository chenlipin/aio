package top.suilian.aio.service.nivex0.newKline;
...
public class RunNewNivexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewNivexKline kline = new NewNivexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewNivexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
