...
public class RunNivexRep2Hot {
    ...
    public void init(int id) {
        //实例化策略对象
        NivexRep2Hot randomDepth = new NivexRep2Hot(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NivexRep2Hot randomDepth;

        public Work(NivexRep2Hot randomDepth) {
