package top.suilian.aio.service.nivex0.replenish;
...
@Component
public class RunNivexReplenish {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NivexReplenish randomDepth = new NivexReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NivexReplenish randomDepth;

        public Work(NivexReplenish randomDepth) {
