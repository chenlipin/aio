...
@Component
public class RunNivexRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NivexRandomDepth randomDepth = new NivexRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NivexRandomDepth randomDepth;

        public Work(NivexRandomDepth randomDepth) {
