...
public class RunIexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        IexKline kline = new IexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
