...
public class RunGateDeep {
    ...
    public void init(int id) {
        //实例化策略对象
        GateDeep randomDepth = new GateDeep(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        GateDeep randomDepth;

        public Work(GateDeep randomDepth) {
