package top.suilian.aio.service.gate.refToHot;
...
public class RunGateRep2Hot {
    ...
    public void init(int id) {
        //实例化策略对象
        GateRep2Hot randomDepth = new GateRep2Hot(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        GateRep2Hot randomDepth;

        public Work(GateRep2Hot randomDepth) {
