package top.suilian.aio.service.gate.RandomDepth;
...
public class GateDeep extends GateParentService {
    public GateDeep(
        ...
        super.id = id;
        super.logger = getLogger("gate/deepNew", id);
    }
    ...
    public void init() {
        ...
        if (tradesObj != null && tradesObj.getString("result").equals("true")) {
            ...
            BigDecimal sellPriDeep2 = new BigDecimal(String.valueOf(sellPrices.get(sellPrices.size()-deepNum1).get(0)));

            BigDecimal buyPriRange = new BigDecimal(String.valueOf(buyPrices.get(deepNum2).get(0)));

            BigDecimal sellPriRange = new BigDecimal(String.valueOf(sellPrices.get(sellPrices.size()-deepNum2).get(0)));
