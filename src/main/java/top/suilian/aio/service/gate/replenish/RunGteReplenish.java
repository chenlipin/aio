...
public class RunGteReplenish {
    ...
    public void init(int id) {
        //实例化策略对象
        GateReplenish randomDepth = new GateReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        GateReplenish randomDepth;

        public Work(GateReplenish randomDepth) {
