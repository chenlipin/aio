...
public class RunIdcmKline {
    ...
    public void init(int id) {
        //实例化策略对象
        IdcmKline kline = new IdcmKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
