package top.suilian.aio.service.fchain.kline;
...
public class RunFChainKline {
    ...
    public void init(int id) {
        //实例化策略对象
        FChainKline kline = new FChainKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
