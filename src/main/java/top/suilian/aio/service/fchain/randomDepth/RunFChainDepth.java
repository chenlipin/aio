...
public class RunFChainDepth {
    ...
    public void init(int id) {
        //实例化策略对象
        FChainDepth kline = new FChainDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
