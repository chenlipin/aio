...
@Component
public class RunKlineReferToZg {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        KlineToZg kline = new KlineToZg(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
