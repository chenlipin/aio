package top.suilian.aio.service.laex.kline;
...
public class RunLaexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        LaexKline kline = new LaexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
