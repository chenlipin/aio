...
@Component
public class RunDepthReferToZg {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        DepthToZg kline = new DepthToZg(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
