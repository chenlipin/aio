...
@Component
public class RunNewBithumbKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewBithumbKline kline = new NewBithumbKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewBithumbKline kline;

        public Work(NewBithumbKline kline) {
            super(kline.id);
            this.kline = kline;
        }
