...
public class NewXoxoexKline extends XoxoexParentService {
    public NewXoxoexKline(
    ...
    private void startOpenInterval(BigDecimal buyPri, BigDecimal buyAmount) {
        try {
            ...
            JSONObject jsonObject = judgeRes(resultJson, "data", "submitTrade");
            if (resultJson != null && !resultJson.equals("") && "ok".equals(jsonObject.getString("status"))) {
                ...
                if (str != null && result != null&&result.getString("data")!=null) {
