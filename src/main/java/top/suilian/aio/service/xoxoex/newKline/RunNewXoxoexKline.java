package top.suilian.aio.service.xoxoex.newKline;
...
import top.suilian.aio.service.xoxoex.kline.XoxoexKline;
...
@Component
public class RunNewXoxoexKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewXoxoexKline kline = new NewXoxoexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewXoxoexKline kline;

        public Work(NewXoxoexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
