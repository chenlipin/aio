package top.suilian.aio.service.xoxoex.randomDepth;
...
public class XoxoexDepth extends XoxoexParentService {
    public XoxoexDepth(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_XOXOEX_DEPTH, id);
    }
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        if (Integer.parseInt(exchange.get("depthCancelNum")) >= depthCancelOrderNum) {
            ...
            try {
                ...
                JSONObject buyResultObject = judgeRes(resultBuy, "data", "submitTrade");
                if("ok".equals(buyResultObject.getString("status"))){
            ...
            try {
                ...
                JSONObject sellResultObject = judgeRes(resultSell, "data", "submitTrade");
                if("ok".equals(sellResultObject.getString("status"))){
    ...
    public void JudegOrder(JSONObject object) throws UnsupportedEncodingException {
        if (object != null && "ok".equals(object.getString("status"))) {
