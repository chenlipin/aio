...
public class RunXoxoexDepth {
    ...
    public void init(int id) {
        //实例化策略对象
        XoxoexDepth randomDepth = new XoxoexDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        XoxoexDepth randomDepth;

        public Work(XoxoexDepth randomDepth) {
