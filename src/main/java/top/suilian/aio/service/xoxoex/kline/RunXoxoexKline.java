...
public class RunXoxoexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        XoxoexKline kline = new XoxoexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
