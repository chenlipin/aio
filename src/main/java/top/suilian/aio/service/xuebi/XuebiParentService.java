package top.suilian.aio.service.xuebi;
...
public class XuebiParentService extends BaseService {
    public String baseUrl = "https://openapi.xuebi.io";
    ...
    public void setBalanceRedis() throws UnsupportedEncodingException {
        ...
        if (balance == null || overdue) {
            ...
            String baseUrl = "https://openapi.xuebi.io";
            ...
            if(obj!=null&&obj.getJSONObject("data").getJSONArray("coin_list")!=null){
    ...
    public void setCancelOrder(JSONObject cancelRes, String res, String orderId, Integer type) {
        ...
        insertCancel(id, orderId, 1, type, Integer.parseInt(exchange.get("isMobileSwitch")), cancelStatus, res, Constant.KEY_EXCHANGE_XUEBI);
    }
