package top.suilian.aio.service.xuebi.Kline;
...
import top.suilian.aio.service.xuebi.XuebiParentService;
...
public class XuebiKline extends XuebiParentService {
    public XuebiKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_XUEBI_KLINE, id);
    }
    ...
    public void init() {
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            ...
            //获取深度 判断平台撮合是否成功https://openapi.xuebi.io/
            String trades = httpUtil.get("https://openapi.xuebi.io/open/api/market_dept?symbol=" + exchange.get("market") + "&type=step0");
            ...
            if (buyAmount.compareTo(new BigDecimal(exchange.get("buyMinLimitAmount"))) < 1) {
                ...
                try {
                    ...
                    if (jsonObject != null && jsonObject.getInt("code") == 0) {
                        ...
                        sellOrderId = data1.getString("order_id");
                    }
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
            ...
            if (sellAmount.compareTo(new BigDecimal(exchange.get("sellMinLimitAmount"))) < 1) {
                ...
                try {
                    ...
                    if (jsonObject != null && jsonObject.getInt("code") == 0) {
                        ...
                        buyOrderId = data2.getString("order_id");
                    }
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
