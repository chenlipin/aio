...
@Component
public class RunBitbabyRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        BitbabyRandomDepth randomDepth = new BitbabyRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        BitbabyRandomDepth randomDepth;

        public Work(BitbabyRandomDepth randomDepth) {
