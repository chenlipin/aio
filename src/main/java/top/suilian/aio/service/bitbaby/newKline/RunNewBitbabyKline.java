package top.suilian.aio.service.bitbaby.newKline;
...
@Component
public class RunNewBitbabyKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewBitbabyKline kline = new NewBitbabyKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewBitbabyKline kline;

        public Work(NewBitbabyKline kline) {
            super(kline.id);
            this.kline = kline;
        }
