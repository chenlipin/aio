package top.suilian.aio.service.bitbaby.replenish;
...
@Component
public class RunBitbabyReplenish {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        BitbabyReplenish randomDepth = new BitbabyReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        BitbabyReplenish randomDepth;

        public Work(BitbabyReplenish randomDepth) {
