...
public class LbankParentService extends BaseService implements RobotAction {
    public String baseUrl = "https://api.lbank.info";
    ...
    public String getDepth() {
        return httpUtil.get("https://api.lbank.info/v2/depth.do?size=1&symbol=" + exchange.get("market"));
    }
