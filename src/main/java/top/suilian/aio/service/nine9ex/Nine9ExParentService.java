...
public class Nine9ExParentService extends BaseService {
    public String baseUrl = "https://www.99ex.com";
    ...
    public void setCancelOrder(JSONObject cancelRes, String res, String orderId, Integer type) {
        ...
        insertCancel(id, orderId, 1, type, Integer.parseInt(exchange.get("isMobileSwitch")), cancelStatus, res, Constant.KEY_EXCHANGE_99EX);
    }
