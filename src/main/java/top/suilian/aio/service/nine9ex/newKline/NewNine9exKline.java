package top.suilian.aio.service.nine9ex.newKline;
...
public class NewNine9exKline extends Nine9ExParentService {
    public NewNine9exKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_99EX_KLINE, id);
    }
