...
import top.suilian.aio.service.nine9ex.kline.Nine9ExKline;
...
@Component
public class RunNewNine9exKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewNine9exKline kline = new NewNine9exKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewNine9exKline kline;

        public Work(NewNine9exKline kline) {
            super(kline.id);
            this.kline = kline;
        }
