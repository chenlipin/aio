...
public class RunNine9ExKline {
    ...
    public void init(int id) {
        //实例化策略对象
        Nine9ExKline kline = new Nine9ExKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(Nine9ExKline kline) {
            super(kline.id);
            this.kline = kline;
        }
