...
public class RunNine9exDepth {
    ...
    public void init(int id) {
        //实例化策略对象
        Nine9exDepth kline = new Nine9exDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(Nine9exDepth kline) {
            super(kline.id);
            this.kline = kline;
        }
