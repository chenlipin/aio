package top.suilian.aio.service.gwet.Kline;
...
public class RunGwetKline {
    ...
    public void init(int id) {
        //实例化策略对象
        GwetKline kline = new GwetKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
