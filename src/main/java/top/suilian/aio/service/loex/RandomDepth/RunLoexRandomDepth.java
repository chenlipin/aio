...
import top.suilian.aio.service.test.RandomDepth.TestRandomDepth;
...
@Component
public class RunLoexRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        LoexRandomDepth randomDepth = new LoexRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        LoexRandomDepth randomDepth;

        public Work(LoexRandomDepth randomDepth) {
