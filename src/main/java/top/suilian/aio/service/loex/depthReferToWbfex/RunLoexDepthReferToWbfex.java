...
@Component
public class RunLoexDepthReferToWbfex {
    ...
    public void init(int id) {
        //实例化策略对象
        LoexDepthReferToWbfex kline = new LoexDepthReferToWbfex(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        LoexDepthReferToWbfex kline;

        public Work(LoexDepthReferToWbfex kline) {
            super(kline.id);
            this.kline = kline;
        }
