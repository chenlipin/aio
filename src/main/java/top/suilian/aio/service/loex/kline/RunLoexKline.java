package top.suilian.aio.service.loex.kline;
...
public class RunLoexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        LoexKline kline = new LoexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
