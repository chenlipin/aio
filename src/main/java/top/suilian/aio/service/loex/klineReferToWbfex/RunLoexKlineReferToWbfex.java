...
import top.suilian.aio.service.eg.klineReferToZg.EgKlineToZg;
...
@Component
public class RunLoexKlineReferToWbfex {
    ...
    public void init(int id) {
        //实例化策略对象
        LoexKlineReferToWbfex kline = new LoexKlineReferToWbfex(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        LoexKlineReferToWbfex kline;

        public Work(LoexKlineReferToWbfex kline) {
            super(kline.id);
            this.kline = kline;
        }
