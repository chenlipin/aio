...
public class RunNewLoexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewLoexKline kline = new NewLoexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewLoexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
