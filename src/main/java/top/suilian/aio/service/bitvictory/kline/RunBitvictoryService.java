...
@Component
public class RunBitvictoryService {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        BitvictoryKline kline = new BitvictoryKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        BitvictoryKline kline;

        public Work(BitvictoryKline kline) {
            super(kline.id);
            this.kline = kline;
        }
