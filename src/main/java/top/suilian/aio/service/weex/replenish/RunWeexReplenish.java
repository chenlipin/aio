...
public class RunWeexReplenish {
    ...
    public void init(int id) {
        //实例化策略对象
        WeexReplenish randomDepth = new WeexReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        WeexReplenish randomDepth;

        public Work(WeexReplenish randomDepth) {
