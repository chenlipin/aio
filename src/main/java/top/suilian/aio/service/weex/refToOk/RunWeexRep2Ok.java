package top.suilian.aio.service.weex.refToOk;
...
public class RunWeexRep2Ok {
    ...
    public void init(int id) {
        //实例化策略对象
        WeexRep2Ok randomDepth = new WeexRep2Ok(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        WeexRep2Ok randomDepth;

        public Work(WeexRep2Ok randomDepth) {
