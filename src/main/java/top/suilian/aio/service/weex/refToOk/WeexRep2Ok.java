...
public class WeexRep2Ok extends WeexParentService {
    public WeexRep2Ok(
    ...
    public void init()  {
        ...
        if (tradesObj != null && tradesObj.getString("code").equals("00000") ) {
            try {
                ...
                String kline = HttpUtil.get("https://api-spot.weex.com/api/v2/market/candles?&period=30m&limit=1&symbol=" + exchange.get("market"));
                //1分钟的开盘价
