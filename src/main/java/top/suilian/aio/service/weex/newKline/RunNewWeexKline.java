package top.suilian.aio.service.weex.newKline;
...
public class RunNewWeexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewWeexKline kline = new NewWeexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewWeexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
