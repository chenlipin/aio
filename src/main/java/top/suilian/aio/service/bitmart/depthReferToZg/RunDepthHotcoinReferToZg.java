...
@Component
public class RunDepthHotcoinReferToZg {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        DepthHotcoinReferToZg kline = new DepthHotcoinReferToZg(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        DepthHotcoinReferToZg kline;

        public Work(DepthHotcoinReferToZg kline) {
            super(kline.id);
            this.kline = kline;
        }
