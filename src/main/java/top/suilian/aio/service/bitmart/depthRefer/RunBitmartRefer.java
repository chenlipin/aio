...
public class RunBitmartRefer {
    ...
    public void init(int id) {
        //实例化策略对象
        BitmartRefer kline = new BitmartRefer(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(BitmartRefer kline) {
            super(kline.id);
            this.kline = kline;
        }
