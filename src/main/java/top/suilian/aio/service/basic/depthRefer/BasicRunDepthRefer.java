...
@Component
public class BasicRunDepthRefer {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        BasicDepth kline = new BasicDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
