...
public class NewBasicKline extends BasicParentService {
    public NewBasicKline(
...
//                runHotcoinRandomDepth.init(id + 1);
        ...
        if (runTime < timeSlot) {
            String trades = httpUtil.get(baseUrl + "/api/v1/depth?pair=" + exchange.get("market"));
            //获取深度 判断平台撮合是否成功
            ...
            try {
                ...
                if (jsonObject != null && jsonObject.getInt("code") == 200) {
                    ...
                    if (jsonObject1 != null && jsonObject1.getInt("code") == 200) {
                        ...
                        String res = cancalOrder(tradeId);
        ...
        try {
            ...
            if (jsonObject != null && jsonObject.getInt("code") == 200) {
                ...
                if (status == 3) {
                    ...
                    String res = cancalOrder(orderId);
                    JSONObject cancelRes = judgeRes(res, "code", "cancelTrade");
