package top.suilian.aio.service.basic.newKline;
...
public class RunNewBasicKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewBasicKline kline = new NewBasicKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewBasicKline kline) {
            super(kline.id);
            this.kline = kline;
        }
