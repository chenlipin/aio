...
public class XtKline extends XtParentService {
    public XtKline(
        ...
        super.id = id;
        super.logger = getLogger("xt/newkline", id);
    }
...
//            System.out.println(getAllOrderPonses);
            //判断走K线的方式
        ...
        if (runTime < timeSlot) {
            ...
            if (tradesObj != null && tradesObj.getInteger("rc") == 0) {
            ...
            try {
                ...
                if (jsonObject != null && jsonObject.getInt("rc") == 0) {
                    orderIdOne = jsonObject.getJSONObject("result").getString("orderId");
                    String resultJson1 = submitTrade(type == 1 ? -1 : 1, price, num);
                    JSONObject jsonObject1 = judgeRes(resultJson1, "code", "submitTrade");

                    if (jsonObject1 != null && jsonObject1.getInt("rc") == 0) {
                        orderIdTwo =jsonObject1.getJSONObject("result").getString("orderId");
                        ...
                        if ("0".equals(exchange.get("isSuspendTrade"))) {
                            if (maxEatOrder == 0 || maxEatOrder > eatOrder) {
                                ...
                                try {
                                    ...
                                    if (jsonObject != null && jsonObject.getInt("rc") == 0) {
                                        sellOrderId = jsonObject.getJSONObject("result").getString("orderId");
                                    }
                                    return price;
                                } catch (Exception e) {
                                    e.printStackTrace();
                        ...
                        if ("0".equals(exchange.get("isSuspendTrade"))) {
                            if (maxEatOrder == 0 || maxEatOrder > eatOrder) {
                                ...
                                try {
                                    ...
                                    JSONObject jsonObject = judgeRes(buyOrder, "rc", "submitTrade");
                                    if (jsonObject != null && jsonObject.getInt("rc") == 0) {
                                        orderIdOne = jsonObject.getJSONObject("result").getString("orderId");
                                    }
                                    return price;
        ...
        public void selectOrderDetail (String orderId,int type){
            try {
                ...
                if (jsonObject != null && jsonObject.getInt("rc") == 0) {
                    ...
                    String status = jsonObject.getJSONObject("result").getString("state");
