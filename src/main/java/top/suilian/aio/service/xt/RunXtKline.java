...
public class RunXtKline {
    ...
    public void init(int id) {
        //实例化策略对象
        XtKline kline = new XtKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
