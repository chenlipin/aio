package top.suilian.aio.service.xt.replenish;
...
public class RunXtReplenish {
    ...
    public void init(int id) {
        //实例化策略对象
        XtReplenish randomDepth = new XtReplenish(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        XtReplenish randomDepth;

        public Work(XtReplenish randomDepth) {
