...
public class RunSCancel {
    ...
    public void init(int id) {
        //实例化策略对象
        SCancel cancel = new SCancel(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
        ...
        public void dowork() {
            ...
            if (robot != null && redisHelper.getRobot(name).getStatus() == Constant.KEY_ROBOT_STATUS_RUN) {
                ...
                try {
                    ...
                    } else if (System.currentTimeMillis() - Long.valueOf(redisHelper.getParam(cancel.id + key)) > Constant.KEY_SNS_INTERFACE_ERROR_TIME) {
