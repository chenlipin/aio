...
public class RunSKline {
    ...
    public void init(int id) {
        //实例化策略对象
        SKline kline = new SKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
