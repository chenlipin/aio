package top.suilian.aio.service.digifinex.kline;
...
public class DigifinexKline extends DigifinexParentService {
    public DigifinexKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_DIGIFINEX_KLINE, id);
    }
    ...
    public void init(){
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            ...
            //获取深度 判断平台撮合是否成功
            String trades = httpUtil.get(baseUrl + "/order_book?symbol=" + exchange.get("market"));
            ...
            if (!"".equals(trades) && trades != null && !trades.isEmpty() && tradesObj != null) {
                ...
                BigDecimal sellPri = new BigDecimal(String.valueOf(sellPrices.get(9).get(0)));
            ...
            int type = Math.ceil(Math.random() * 10 + 1) > 7 ? 1 : 2;

            try {
                String resultJson = submitOrder(type, price, num);
                JSONObject jsonObject = judgeRes(resultJson, "order_id", "submitTrade");
                ...
                if (jsonObject != null && "0".equals(jsonObject.getString("code"))) {
                    ...
                    JSONObject jsonObject1 = judgeRes(resultJson1, "order_id", "submitTrade");

                    if (jsonObject1 != null && "0".equals(jsonObject1.getString("code"))) {
                        String tradeId1 = jsonObject1.getString("order_id");
                        orderIdTwo = tradeId1;
    ...
    public BigDecimal getRandomPrice() {
        ...
        if (!"".equals(trades) && trades != null && !trades.isEmpty() && tradesObj != null) {
            ...
            BigDecimal sellAmount = new BigDecimal(String.valueOf(sellPrices.get(9).get(1)));
    ...
    public void selectOrderDetail(String orderId, int type) {
        try {
            ...
            JSONObject resJson = JSONObject.fromObject(jsonObject.getJSONArray("data").get(0));
