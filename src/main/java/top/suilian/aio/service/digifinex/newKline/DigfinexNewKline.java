...
public class DigfinexNewKline extends DigifinexParentService {
    public DigfinexNewKline(
        ...
        if (runTime < timeSlot) {
            ...
            try {
                ...
                if (jsonObject != null && jsonObject.getInt("code") == 0) {
                    ...
                    orderIdOne = tradeId;
                    String resultJson1 = submitOrder(type == 1 ? -1 : 1, price, num);
                ...
                if ("1".equals(exchange.get("isTradeCheck"))&&buyAmount.compareTo(new BigDecimal(exchange.get("buyMinLimitAmount"))) < 1 && "1".equals(exchange.get("isBuyMinLimitAmount"))) {
                    if ("0".equals(exchange.get("isSuspendTrade"))) {
                        if (maxEatOrder == 0 || maxEatOrder > eatOrder) {
                            ...
                            try {
                                String sellOrder = submitOrder(-1, buyPri, buyAmount);
