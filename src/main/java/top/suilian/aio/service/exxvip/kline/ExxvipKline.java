package top.suilian.aio.service.exxvip.kline;
...
import top.suilian.aio.service.exxvip.ExxvipParentService;
...
public class ExxvipKline extends ExxvipParentService {
    public ExxvipKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_EXXVIP_KLINE, id);
    }
    ...
    public void init() {
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            ...
            if (!"".equals(trades) && trades != null &&result.getJSONArray("bids").size()>0) {
            ...
            try {
                ...
                if (jsonObject != null && jsonObject.getInt("code")==100) {
                    ...
                    if (jsonObject1 != null && jsonObject1.getInt("code")==100) {
            ...
            if (sellAmount.compareTo(new BigDecimal(exchange.get("sellMinLimitAmount"))) < 1 ) {
                if(eatOrder==0||eatOrder<maxEatOrder){
                    try {
                        ...
                        if (jsonObject != null && jsonObject.getInt("id")==100) {
    ...
    public void selectOrderDetail(String orderId, int type) {
        ...
        try {
            ...
            JSONObject jsonObject = judgeRes(str, "id", "selectOrder");
            if (jsonObject != null && !"".equals(jsonObject.getString("id"))) {
                ...
                if ("2".equals(status)) {
                    ...
                    if(res!=null&&resObj.getInt("code")==100){
                    setCancelOrder(resObj, res, orderId, Constant.KEY_CANCEL_ORDER_TYPE_QUANTIFICATION);
