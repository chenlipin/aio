...
public class RunExxvipKline {
    ...
    public void init(int id) {
        //实例化策略对象
        ExxvipKline kline = new ExxvipKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
