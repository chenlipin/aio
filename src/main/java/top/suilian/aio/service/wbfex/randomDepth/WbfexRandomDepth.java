package top.suilian.aio.service.wbfex.randomDepth;
...
public class WbfexRandomDepth extends WbfexParentService {

    public WbfexRandomDepth(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_WBFEX_DEPTH, id);
    }
    ...
    public void init() {
        ...
        if (Integer.parseInt(exchange.get("depthCancelNum")) >= depthCancelOrderNum) {
            ...
            try {
                ...
                if(buyResultObject!=null&&buyResultObject.getInt("code")==0){
            ...
            try {
                ...
                if(sellResultObject!=null&&sellResultObject.getInt("code")==0){
    ...
    public void JudegOrder(JSONObject object) throws UnsupportedEncodingException {
        if (object != null && object.getInt("code")==0) {
            JSONObject orderResult = object.getJSONObject("data");
            String tradeId = orderResult.getString("order_id");
