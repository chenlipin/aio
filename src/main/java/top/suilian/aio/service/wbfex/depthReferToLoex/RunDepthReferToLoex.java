...
@Component
public class RunDepthReferToLoex {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        DepthToLoex kline = new DepthToLoex(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
