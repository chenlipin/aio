...
@Component
public class RunWebfexRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        WbfexRandomDepth randomDepth = new WbfexRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        WbfexRandomDepth randomDepth;

        public Work(WbfexRandomDepth randomDepth) {
