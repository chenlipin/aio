...
public class RunWbfexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        WbfexKline kline = new WbfexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
