...
@Component
public class RunKlineReferToLoex {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        KlineToLoex kline = new KlineToLoex(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
