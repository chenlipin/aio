...
import top.suilian.aio.service.wbfex.kline.WbfexKline;
...
public class RunNewWbfexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewWbfexKline kline = new NewWbfexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewWbfexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
