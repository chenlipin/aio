package top.suilian.aio.service.eeee.newKline;
...
public class RunNew4EKline {
    ...
    public void init(int id) {
        //实例化策略对象
        New4EKline kline = new New4EKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
