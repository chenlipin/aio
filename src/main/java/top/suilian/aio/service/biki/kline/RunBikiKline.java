...
public class RunBikiKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BikiKline kline = new BikiKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
        ...
        public void dowork() {
            ...
            if (robot != null && redisHelper.getRobot(name).getStatus() == Constant.KEY_ROBOT_STATUS_RUN) {
                ...
                try {
                    ...
                    redisHelper.setParam("Exception_" + kline.id, strs);
                    if (redisHelper.getParam(kline.id + key) == null) {
