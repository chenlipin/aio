package top.suilian.aio.service.pcas.kline;
...
public class RunPcasKline {
    ...
    public void init(int id) {
        //实例化策略对象
        PcasKline kline = new PcasKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
