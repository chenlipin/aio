...
@Component
public class RunPcasKlineReferToHuobi {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        PcasKlineToHuobi kline = new PcasKlineToHuobi(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        PcasKlineToHuobi kline;

        public Work(PcasKlineToHuobi kline) {
            super(kline.id);
            this.kline = kline;
        }
