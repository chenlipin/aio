...
@Component
public class RunPcasDepthReferToHuobi {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        PcasDepthToHuobi kline = new PcasDepthToHuobi(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        PcasDepthToHuobi kline;

        public Work(PcasDepthToHuobi kline) {
            super(kline.id);
            this.kline = kline;
        }
