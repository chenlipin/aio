...
public class RunRonanceKline {
    ...
    public void init(int id) {
        //实例化策略对象
        RonanceKline kline = new RonanceKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(RonanceKline kline) {
            super(kline.id);
            this.kline = kline;
        }
