...
public class RunBisionKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BisionKline kline = new BisionKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
