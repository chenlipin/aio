package top.suilian.aio.service.bision.kline;
...
public class BisionKline extends BisionParentService {
    public BisionKline(
    ...
    public void init() {
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            ...
            JSONObject tradesObj = judgeRes(trades, "last", "getRandomPrice");

            if (tradesObj != null && tradesObj.getString("asks")!=null) {
...
//                    orderIdOne = tradeId;
                    ...
                    if (jsonObject1 != null && jsonObject1.getString("code").equals("200")) {
                        String tradeTwo = jsonObject1.getJSONObject("data").getString("id");
...
//                        orderIdTwo = tradeTwo;
    ...
    public String getDepth() {
        String trades = httpUtil.get(baseUrl + "/data/api/v1/getDepth?market="+exchange.get("market"));
        return trades;
    }
    ...
    public BigDecimal getRandomPrice() {
        ...
        if (tradesObj != null && tradesObj.getString("asks")!=null) {
            ...
            if (buyAmount.compareTo(new BigDecimal(exchange.get("buyMinLimitAmount"))) < 1) {
                ...
                try {
                    submitTrade(0, buyPri, buyAmount);
            ...
            if (sellAmount.compareTo(new BigDecimal(exchange.get("sellMinLimitAmount"))) < 1) {
                ...
                try {
                    submitTrade(1, sellPri, sellAmount);
