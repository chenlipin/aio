...
public class RunCoinWDeep {
    ...
    public void init(int id) {
        //实例化策略对象
        CoinWDeep randomDepth = new CoinWDeep(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        CoinWDeep randomDepth;

        public Work(CoinWDeep randomDepth) {
