...
public class RunMxcKline {
    ...
    public void init(int id) {
        //实例化策略对象
        MxcKline kline = new MxcKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
