...
import top.suilian.aio.service.mxc.kline.MxcKline;
...
public class RunNewMxcKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewMxcKline kline = new NewMxcKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
