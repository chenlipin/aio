package top.suilian.aio.service.mxc.hotcoin.kline;
...
public class RunHotCoinKline {
    ...
    public void init(int id) {
        //实例化策略对象
        HotCoinKline kline = new HotCoinKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(HotCoinKline kline) {
            super(kline.id);
            this.kline = kline;
        }
