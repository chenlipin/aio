...
import top.suilian.aio.service.coinvv.kline.CoinvvKline;
...
public class RunCoinvvKline {
    ...
    public void init(int id) {
        //实例化策略对象
        CoinvvKline kline = new CoinvvKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
