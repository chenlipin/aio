...
public class RunBbkxKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BbkxKline kline = new BbkxKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
