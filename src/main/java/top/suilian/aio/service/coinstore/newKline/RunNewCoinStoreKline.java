...
@Component
public class RunNewCoinStoreKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewCoinStoreKline kline = new NewCoinStoreKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewCoinStoreKline kline;

        public Work(NewCoinStoreKline kline) {
            super(kline.id);
            this.kline = kline;
        }
