...
@Component
public class RunCoinStoreRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        CoinStoreRandomDepth randomDepth = new CoinStoreRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        CoinStoreRandomDepth randomDepth;

        public Work(CoinStoreRandomDepth randomDepth) {
