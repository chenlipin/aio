package top.suilian.aio.service.pickcoin.randomDepth;
...
public class RunPickcoinDepth{
    ...
    public void init(int id) {
        //实例化策略对象
        PickcoinDepth randomDepth = new PickcoinDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        PickcoinDepth randomDepth;

        public Work(PickcoinDepth randomDepth) {
