...
public class RunPickcoinKline {
    ...
    public void init(int id) {
        //实例化策略对象
        PickcionKline kline = new PickcionKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(PickcionKline kline) {
            super(kline.id);
            this.kline = kline;
        }
