...
//        //实例化策略对象
//        FirstvKline kline = new FirstvKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
...
//                        commonUtil.sendSms(kline.id + "异常机器人停止");
//                    }
//                }
//            } else {
//                killWork(kline.id);
