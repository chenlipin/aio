package top.suilian.aio.service.arbisoo.newKline;
...
public class ArbisooKline extends ArbisooParentService {
    public ArbisooKline(
    ...
    public void init() throws Exception {
        ...
        if (runTime < timeSlot) {
            ...
            if (tradesObj != null && "200".equals(tradesObj.getString("code"))  ) {

                com.alibaba.fastjson.JSONObject data = tradesObj.getJSONObject("data");

                JSONArray selllist_krcusdt = data.getJSONArray("selllist_"+exchange.get("market"));
                JSONArray buylist_krcusdt = data.getJSONArray("buylist_"+exchange.get("market"));

                BigDecimal buyPri = new BigDecimal(String.valueOf(buylist_krcusdt.getJSONObject(0).getString("price")));
                BigDecimal sellPri = new BigDecimal(String.valueOf(selllist_krcusdt.getJSONObject(selllist_krcusdt.size()-1).getString("price")));
            ...
            try {
                ...
                if (jsonObject != null && jsonObject.getInt("code") == 200) {
                    orderIdOne = jsonObject.getJSONObject("data").getString("order_no");
                    ...
                    if (jsonObject1 != null && jsonObject1.getInt("code") == 200) {
                        orderIdTwo = jsonObject1.getJSONObject("data").getString("order_no");
    ...
    public void selectOrderDetail(String orderId, int type) {
        try {
            ...
            if (jsonObject != null && jsonObject.getInt("code") == 200) {
                JSONObject data = jsonObject.getJSONObject("data").getJSONArray("data").getJSONObject(0);
