package top.suilian.aio.service.bkex.coinnoe.newKline;
...
public class RunNewBkexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewBkexKline kline = new NewBkexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewBkexKline kline) {
            super(kline.id);
            this.kline = kline;
        }
