...
@Component
public class RunEuexKlineReferToBibox {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        EuexReferKlineToBibox kline = new EuexReferKlineToBibox(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        EuexReferKlineToBibox kline;

        public Work(EuexReferKlineToBibox kline) {
            super(kline.id);
            this.kline = kline;
        }
