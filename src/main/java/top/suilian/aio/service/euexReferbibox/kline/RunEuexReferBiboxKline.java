...
@Component
public class RunEuexReferBiboxKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        EuexReferBiboxKline kline = new EuexReferBiboxKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        EuexReferBiboxKline kline;

        public Work(EuexReferBiboxKline kline) {
            super(kline.id);
            this.kline = kline;
        }
