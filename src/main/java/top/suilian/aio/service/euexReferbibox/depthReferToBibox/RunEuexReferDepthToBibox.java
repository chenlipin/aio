...
@Component
public class RunEuexReferDepthToBibox {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        EuexReferDepthToBibox kline = new EuexReferDepthToBibox(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        EuexReferDepthToBibox kline;

        public Work(EuexReferDepthToBibox kline) {
            super(kline.id);
            this.kline = kline;
        }
