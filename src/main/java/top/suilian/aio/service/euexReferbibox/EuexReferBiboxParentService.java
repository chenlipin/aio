...
public class EuexReferBiboxParentService extends BaseService {
...
//        String timestamp = JSONObject.fromObject(time).getString("serverTime");
    ...
    public void setBalanceRedis() throws UnsupportedEncodingException {
        ...
        if (balance == null || overdue) {
            ...
            if (obj != null && obj.getJSONObject("data") != null && obj.getJSONObject("data").getJSONObject("balance") != null) {
    ...
    public void setCancelOrder(JSONObject cancelRes, String res, String orderId, Integer type) {
        ...
        insertCancel(id, orderId, 1, type, Integer.parseInt(exchange.get("isMobileSwitch")), cancelStatus, res, Constant.KEY_EXCHANGE_EUEXREFERBIBOX);
    }
