...
public class RunPoloniexRep2Hot {
    ...
    public void init(int id) {
        //实例化策略对象
        PoloniexRep2Hot randomDepth = new PoloniexRep2Hot(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        PoloniexRep2Hot randomDepth;

        public Work(PoloniexRep2Hot randomDepth) {
