package top.suilian.aio.service.bgoex.newKline;
...
public class RunNewBgoKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewBgoKline kline = new NewBgoKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
