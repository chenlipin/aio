package top.suilian.aio.service.euex.depthReferToZg;
...
@Component
public class RunEuexDepthReferToZg {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        EuexDepthToZg kline = new EuexDepthToZg(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(EuexDepthToZg kline) {
            super(kline.id);
            this.kline = kline;
        }
