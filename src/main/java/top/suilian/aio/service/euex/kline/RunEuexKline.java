package top.suilian.aio.service.euex.kline;
...
public class RunEuexKline {
    ...
    public void init(int id) {
        //实例化策略对象
        EuexKline kline = new EuexKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
