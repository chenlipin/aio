...
public class EuexDepthToZg extends EuexParentService {
    public EuexDepthToZg(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_EUEX_REFER_DEPTH, id);
    }
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        //获取zg深度
        String trades = httpUtil.get(referBaseUrl + "/depth?symbol=" + exchange.get("market").toUpperCase() + "&size=" + exchange.get("depthNum"));
