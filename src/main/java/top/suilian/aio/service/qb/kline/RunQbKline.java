...
public class RunQbKline {
    ...
    public void init(int id) {
        //实例化策略对象
        QbKline kline = new QbKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
