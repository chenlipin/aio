...
@Component
public class RunKlineReferToBitai {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        KlineToBitai kline = new KlineToBitai(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(KlineToBitai kline) {
            super(kline.id);
            this.kline = kline;
        }
