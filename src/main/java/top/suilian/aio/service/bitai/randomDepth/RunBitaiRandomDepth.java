...
@Component
public class RunBitaiRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        BitaiRandomDepth randomDepth = new BitaiRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        BitaiRandomDepth randomDepth;

        public Work(BitaiRandomDepth randomDepth) {
