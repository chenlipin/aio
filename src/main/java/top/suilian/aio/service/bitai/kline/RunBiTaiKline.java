package top.suilian.aio.service.bitai.kline;
...
public class RunBiTaiKline {
    ...
    public void init(int id) {
        //实例化策略对象
        BiTaiKline kline = new BiTaiKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
