package top.suilian.aio.service.bitai.newKline;
...
import top.suilian.aio.service.bitai.kline.BiTaiKline;
...
public class RunNewBitaiKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewBitaiKline kline = new NewBitaiKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewBitaiKline kline) {
            super(kline.id);
            this.kline = kline;
        }
