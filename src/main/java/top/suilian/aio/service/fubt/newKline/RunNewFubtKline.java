...
public class RunNewFubtKline {
    ...
    public void init(int id) {
        //实例化策略对象
        NewFubtKline kline = new NewFubtKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        ...
        public Work(NewFubtKline kline) {
            super(kline.id);
            this.kline = kline;
        }
