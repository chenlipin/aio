package top.suilian.aio.service.fubt.kline;
...
public class FubtKline extends FubtParentService {
    public FubtKline(
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        if (runTime < Integer.parseInt(exchange.get("timeSlot"))) {
            String param = "symbol=" + exchange.get("market") + "&step=" + "STEP1" + "&accessKey=" + URLEncoder.encode(exchange.get("apikey"), "UTF-8");//传入参数
