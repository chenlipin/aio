...
public class FubtCancel extends FubtParentService {
    public FubtCancel(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_FUBT_CANCEL, id);
    }
    ...
    public void init() {
        ...
        List<CancelOrder> cancelOrderList = cancelOrderService.findByAll(Constant.KEY_EXCHANGE_FUBT, robotId);
