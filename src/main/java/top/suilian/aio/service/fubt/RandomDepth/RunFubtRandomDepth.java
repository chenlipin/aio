...
@Component
public class RunFubtRandomDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        FubtRandomDepth randomDepth = new FubtRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        FubtRandomDepth randomDepth;

        public Work(FubtRandomDepth randomDepth) {
