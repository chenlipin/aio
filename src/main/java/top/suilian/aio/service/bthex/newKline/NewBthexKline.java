package top.suilian.aio.service.bthex.newKline;
...
import top.suilian.aio.service.bthex.BthexParentService;
...
public class NewBthexKline extends BthexParentService {
    public NewBthexKline(
        ...
        super.id = id;
        super.logger = getLogger(Constant.KEY_LOG_PATH_BTHEX_KLINE, id);
    }
    ...
    //存放交易对
    private Map<String, Object> par = new TreeMap<String, Object>();
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        par.put("symbol",exchange.get("market"));
        ...
        if (runTime < timeSlot) {
            ...
            String trades = httpUtil.post(baseUrl+"?action=depth",par);
        ...
        try {
            ...
            if (jsonObject != null && "200".equals(jsonObject.getString("code"))) {
                ...
                if (result != null && result.getInt("code") == 200) {
                    JSONObject orderInfo = result.getJSONObject("data");
    ...
    public void selectOrderDetail(String orderId, int type) {
        try {
            ...
            if (jsonObject != null && jsonObject.getInt("code") == 200) {
                 ...
                 JSONObject orderInfo=list.get(0);
