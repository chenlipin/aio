...
import top.suilian.aio.service.bihu.randomDepth.BiHuRandomDepth;
...
@Component
public class RunTestRandomDepth {
    ...
    public void init(int id) {
        //实例化策略对象
        TestRandomDepth randomDepth = new TestRandomDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        TestRandomDepth randomDepth;

        public Work(TestRandomDepth randomDepth) {
