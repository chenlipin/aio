package top.suilian.aio.service.happycoin.kline;
...
@Component
public class RunHappyCoinKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        HappyCoinKline kline = new HappyCoinKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        HappyCoinKline kline;

        public Work(HappyCoinKline kline) {
            super(kline.id);
            this.kline = kline;
        }
