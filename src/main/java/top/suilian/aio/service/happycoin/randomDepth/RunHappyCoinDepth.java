package top.suilian.aio.service.happycoin.randomDepth;
...
@Component
public class RunHappyCoinDepth {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        HappyCoinDepth randomDepth = new HappyCoinDepth(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        HappyCoinDepth randomDepth;

        public Work(HappyCoinDepth randomDepth) {
