...
import top.suilian.aio.service.happycoin.kline.HappyCoinKline;
...
@Component
public class RunNewHappyCoinKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewHappyCoinKline kline = new NewHappyCoinKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewHappyCoinKline kline;

        public Work(NewHappyCoinKline kline) {
            super(kline.id);
            this.kline = kline;
        }
