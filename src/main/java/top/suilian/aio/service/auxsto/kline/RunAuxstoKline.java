...
public class RunAuxstoKline {
    ...
    public void init(int id) {
        //实例化策略对象
        AuxstoKline kline = new AuxstoKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
