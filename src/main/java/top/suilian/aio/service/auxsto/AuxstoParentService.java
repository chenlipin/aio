...
public class AuxstoParentService extends BaseService {
    public String baseUrl = "https://openapi.auxsto.com";
    ...
    public void setBalanceRedis() throws UnsupportedEncodingException {
        ...
        if (balance == null || overdue) {
            ...
            String baseUrl = "https://openapi.auxsto.com";
            ...
            if(obj!=null&&obj.getJSONObject("data").getJSONObject("coin_list")!=null){
    ...
    public void setCancelOrder(JSONObject cancelRes, String res, String orderId, Integer type) {
        ...
        insertCancel(id, orderId, 1, type, Integer.parseInt(exchange.get("isMobileSwitch")), cancelStatus, res, Constant.KEY_EXCHANGE_AUXSTO);
    }
