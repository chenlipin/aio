...
@Component
public class RunNewWhitebitKline {
    //region    Service
    @Autowired
    ...
    public void init(int id) {
        //实例化策略对象
        NewWhitebitKline kline = new NewWhitebitKline(cancelExceptionService, cancelOrderService, exceptionMessageService, robotArgsService, robotLogService, robotService, tradeLogService, httpUtil, redisHelper, id);
    ...
    class Work extends StopableTask<Work> {
        NewWhitebitKline kline;

        public Work(NewWhitebitKline kline) {
            super(kline.id);
            this.kline = kline;
        }
